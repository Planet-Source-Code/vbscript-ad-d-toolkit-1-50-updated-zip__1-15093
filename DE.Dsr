...
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DE 
   ...
   _ExtentY        =   11033
   FolderFlags     =   7
   TypeLibGuid     =   "{EDD1BC59-676D-44A8-859B-18229BC33550}"
   TypeInfoGuid    =   "{DF2FFEFB-BE48-4999-B9A7-DD382E45FF77}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   BeginProperty Connection1 
      ConnectionName  =   "conCharacter"
      ConnDispId      =   1001
      SourceOfData    =   3
   ...
   BeginProperty Recordset1 
      CommandName     =   "CharInfo"
      CommDispId      =   1018
      RsDispId        =   1040
      CommandText     =   "SELECT tblCharInfo.* FROM tblCharInfo"
      ActiveConnectionName=   "conCharacter"
      CommandType     =   1
   ...
   BeginProperty Recordset2 
      CommandName     =   "CharTurn"
      CommDispId      =   1024
      RsDispId        =   1043
      CommandText     =   "SELECT tblCharTurn.* FROM tblCharTurn"
      ActiveConnectionName=   "conCharacter"
      CommandType     =   1
      IsRSReturning   =   -1  'True
      NumFields       =   15
   ...
   BeginProperty Recordset3 
      CommandName     =   "CharThief"
      CommDispId      =   1030
      RsDispId        =   1046
      CommandText     =   "SELECT tblCharThief.* FROM tblCharThief"
      ActiveConnectionName=   "conCharacter"
      CommandType     =   1
      IsRSReturning   =   -1  'True
      NumFields       =   10
